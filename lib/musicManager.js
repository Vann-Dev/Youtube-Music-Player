...
export function play() {
    ...
    if (!track) return;
    currentTrack = track
    axios.get("https://invidious.privacy.gd/api/v1/videos/" + track.id, { headers: { "User-Agent": "Mozilla/5.0 (Windows; U; Windows NT 6.2) AppleWebKit/532.12.2 (KHTML, like Gecko) Version/4.0 Safari/532.12.2" }}).then(x => {
        document.querySelector('#audio').src = x.data.adaptiveFormats[0].url;
