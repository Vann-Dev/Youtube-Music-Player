...
export default async function search(req, res) {
    ...
    const { data } = await axios.get("https://invidious.osi.kr/api/v1/videos/" + req.query.id, { headers: { "User-Agent": "Mozilla/5.0 (Windows; U; Windows NT 6.2) AppleWebKit/532.12.2 (KHTML, like Gecko) Version/4.0 Safari/532.12.2" }});
